...
import { generateIdeaForChannel, markChannelPosted } from '@/lib/client-api';
import { StatusStrip } from './StatusStrip';
import { DashboardCard } from './DashboardCard';

export function DashboardScreen({ initialEntries }: { initialEntries: DashboardEntryDTO[] }) {
  ...
  const noIdeaChannelIds = useMemo(
    () => entries.filter((e) => getDashboardState(e.plan) === 'no-idea').map((e) => e.channel.id),
    [entries]
  );
